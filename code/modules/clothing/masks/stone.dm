/obj/item/clothing/mask/stone
	...
	icon_state = "stone"
	item_state = "stone"
	icon = 'icons/obj/clothing/masks3.dmi'
	alternate_worn_icon = 'icons/mob/mask3.dmi'
	w_class = 2
		...
		if(H.wear_mask == src) //the mob is wearing this mask
			if(H.mind)
				...
				if(!isvampire(H)) //They are not already a vampire
					...
					send_to_playing_players("<span class='danger'>WRYYYYYYYYYYYYYYYYYYY</span>")
