...
/datum/preferences
	...
	var/list/features = list("mcolor" = "FFF", "tail_lizard" = "Smooth", "tail_human" = "None", "snout" = "Round", "horns" = "None", "ears" = "None", "wings" = "None", "frills" = "None", "spines" = "None", "body_markings" = "None", "legs" = "Normal Legs", "horns_troll" = "Nubby", "troll_caste" = "burgundy")
	...
	switch(current_tab)
		if (0) // Character Settings#
			...
			if(pref_species.has_castes)
				...
				dat += "<a href='?_src_=prefs;preference=t_caste;task=input'>[features["troll_caste"]]</a><BR>"
			...
			if(TROLLHORNS in pref_species.species_traits)
				...
				dat += "<a href='?_src_=prefs;preference=horn_type;task=input'>[features["horns_troll"]]</a><BR>"
			...
			if(((MUTCOLORS in pref_species.species_traits) || (MUTCOLORS_PARTSONLY in pref_species.species_traits)) && (!pref_species.fixed_mut_color))
